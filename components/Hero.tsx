  ...
  return (
    <section className="relative min-h-screen bg-[#0f0f0f] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <p className="hero-rise hero-delay-3 mx-auto mt-6 max-w-3xl font-poppins text-base leading-relaxed text-gray-300 sm:text-lg">
          2PixelCraft is a web design, website development, app development, and custom software agency helping local businesses launch faster and grow with dependable execution.
        </p>

        <div className="hero-rise hero-delay-4 flex justify-center mt-5">
          <svg
            width="340"
            height="18"
            viewBox="0 0 340 18"
        ...
        <div className="hero-rise hero-delay-5 mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#book-call"
